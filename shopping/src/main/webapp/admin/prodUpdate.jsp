...
<form action="prodUpdate_Ok.jsp" method="post" enctype="multipart/form-data">
	<table class="outLine" width="600">
		...
		<tr>
			<th class="m3">상품가격</th>
			<td><input type ="text" name="price" value="<%=pdto.getPrice()%>" maxlength="8"/></td>
		</tr>
		<tr>
			<th class="m3">상품사양</th>
		...
		<tr>
			<th class="m3">상품소개</th>
			<td><textarea rows=5 cols=50 name="pcontents"><%=pdto.getPcontents()%></textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<th colspan=2 class="m1" aligh="center">상품포인트
